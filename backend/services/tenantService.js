...
import { findTenantById, findTenantBySlug, insertTenant, listTenants, setTenantStatus, updateTenant } from '../repositories/tenantRepository.js';
...
export class TenantService {
  ...
  async updateTenant(tenantId, fields) {
    ...
    try {
      ...
      assert(existing, 'Tenant not found', 404);
