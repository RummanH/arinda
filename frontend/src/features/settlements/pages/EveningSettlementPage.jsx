              ...
              {vm.extraReturns.length ? (
                <div className="space-y-3">
                  {vm.extraReturns.map((row) => {
                    ...
                    return (
                      <div key={row.id} className="grid gap-3 rounded-[22px] border border-slate-200 bg-slate-50 p-4 lg:grid-cols-[minmax(0,1.8fr)_minmax(140px,0.55fr)_minmax(140px,0.55fr)_auto]">
                        <div>
